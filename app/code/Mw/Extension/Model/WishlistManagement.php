...
use Exception;
use Mw\Extension\Api\WishlistManagementInterface;
...
/**
 * Defines the implementaiton class of the \Mw\Exteansion\Api\WishlistManagementInterface
 */
class WishlistManagement implements
    \Mw\Extension\Api\WishlistManagementInterface
{
        ...
        if (empty($customerId) || !isset($customerId) || $customerId == "") {
            ...
            foreach ($collection as $item) {
                ...
                $data = [
                    ...
                    "product"          => $productInfo,
                    "image"            => $this->imageHelper->init($item->getProduct(), 'product_base_image')->getUrl()
                ];
                $wishlistData[] = $data;
            }
            return $wishlistData;
    ...
    public function addWishlistForCustomer($customerId, $productId)
    {
        ...
        try {
            ...
            $currWishlist = $this->getWishlistForCustomer($customerId);
            // foreach ($currWishlist as $curr) {
            //     if ($productId == $curr['product_id']) {
            //         $output = $curr;
            //     }
            // }
        } catch (Exception $e) {
