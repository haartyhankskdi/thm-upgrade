...
class ThreeDSecureCheck extends Column
{
    /**
     * @var \Ebizmarts\BrippoPayments\Model\OrderGridInfo
     */
    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        return $this->orderGridColumns->prepareColumn($dataSource, "three_d_secure", $fieldName);
    }
