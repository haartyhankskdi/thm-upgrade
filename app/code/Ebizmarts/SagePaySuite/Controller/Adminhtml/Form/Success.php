...
class Success implements ActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $url = $this->backendUrl->getUrl($route, $param);
            ...
            if ($order) {
                ...
                $this->manager
                    ->addErrorMessage("Your payment was successful but the order was NOT created: " . $e->getMessage());
                $route = 'sales/order/view';
                $url = $this->backendUrl->getUrl($route, []);
            }
            $this->redirect->redirect($this->response, $url);
        }
