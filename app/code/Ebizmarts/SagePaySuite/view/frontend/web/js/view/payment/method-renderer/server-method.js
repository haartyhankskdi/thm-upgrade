...
define(
    ...
    function ($, Component, storage, url, urlBuilder, customer, quote, fullScreenLoader, additionalValidators, customerData, setPaymentInformation) {
        'use strict';
        var template = 'Ebizmarts_SagePaySuite/payment/server-form';
        var serverConfig = window.checkoutConfig.payment.ebizmarts_sagepaysuiteserver;
        if (serverConfig && !serverConfig.licensed && serverConfig.mode == "live") {
        ...
        return Component.extend({
                    ...
                    function () {
                        ...
                        $.when(
                            ...
                            function () {
                                ...
                                var serviceUrl = null;
                                if (customer.isLoggedIn()) {
                                    serviceUrl = urlBuilder.createUrl('/elavon/server', {});
                                } else {
                                    serviceUrl = urlBuilder.createUrl('/elavon-guest/server', {});
                                }
                                ...
                                return storage.post(
                                    ...
                                    function (response) {
                                        ...
                                        if (response.success) {
                                            ...
                                            if (self.shouldRedirectToOpayo()) {
                                                window.location.href = sagePayResponse.NextURL;
                                            } else {
            ...
            openSERVERModal: function (nextURL) {
                ...
                var winProfile  = window.checkoutConfig.payment.ebizmarts_sagepaysuiteserver.low_profile ? 'low' : 'normal';
            ...
            shouldRedirectToOpayo: function () {
                return !window.checkoutConfig.payment.ebizmarts_sagepaysuiteserver.low_profile
                    && window.checkoutConfig.payment.ebizmarts_sagepaysuiteserver.payment_layout == 'redirect_to_sagepay';
            },
            ...
            isLicenced: function () {
                return window.checkoutConfig.payment.ebizmarts_sagepaysuiteserver.licensed;
            }
        });
    }
);
