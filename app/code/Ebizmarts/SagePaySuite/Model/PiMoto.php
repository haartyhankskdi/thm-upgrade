...
class PiMoto extends \Magento\Payment\Model\Method\Cc
{
     ...
     * @var string
     */
    protected $_code = Config::METHOD_PI_MOTO; // @codingStandardsIgnoreLine
    ...
    public function __construct(
        ...
        $this->config  = $config;
        $this->config->setMethodCode(\Ebizmarts\SagePaySuite\Model\Config::METHOD_PI_MOTO);
        $this->pirestapi   = $pirestapi;
        $this->pirestapi->setPaymentMethod(true);
