...
namespace Kdi\NewsletterOverride\Rewrite\Magento\Newsletter\Controller\Subscriber;
...
class NewAction extends SubscriberController implements HttpPostActionInterface
{
    ...
    {
        // $this->redirectSetter = '/newsletter-success';
        // $redirect = $this->resultFactory->create(\Magento\Framework\Controller\ResultFactory::TYPE_REDIRECT);
        //     $redirectUrl = $this->redirectSetter;
        ...
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                ...
                if ($subscriber->getId()
                    ...
                    $this->redirectSetter = $this->_redirect->getRedirectUrl();
                }
