...
namespace Haartyhanks\FreeShippingProgressBar\ViewModel\Cart;
...
{
    /**
     * System XML config path for Haartyhanks_FreeShippingBanner - Uses default checkout cart section
     */
  ...
  public function getCurrentTotal(): float
{
    ...
    {
        return $this->session->getQuote()->getItemsCount() == 0;
    }
