...
namespace Amasty\MicrosoftConsentMode\Model;
...
{
    public const ENABLE_MICROSOFT_CONSENT_MODE = 'microsoft_mode/enable';
    public const CONSENT_TYPES = 'microsoft_mode/consent_types';
    ...
    public function isMicrosoftConsentModeEnabled(
        ?int $storeId = null,
        string $scope = ScopeInterface::SCOPE_STORE
    ): bool {
        return $this->isSetFlag(self::ENABLE_MICROSOFT_CONSENT_MODE, $storeId, $scope);
    }
