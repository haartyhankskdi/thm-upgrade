...
namespace Amasty\GoogleConsentMode\Model\OptionSource;
...
class CookieGroups implements OptionSourceInterface
{
     ...
     * @var Collection
     */
    private $cookieGroupsCollection;

    public function __construct(
        Collection $cookieGroupsCollection
    ) {
        $this->cookieGroupsCollection = $cookieGroupsCollection;
    }
