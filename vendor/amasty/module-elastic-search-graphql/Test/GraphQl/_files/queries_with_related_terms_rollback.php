...
$query = $collectionQuery->addFieldToFilter('main_table.query_text', ['in' => ['test']])->getFirstItem();
$queryResource->delete($query);

$collectionQuerySecond = $collectionQueryFactory->create();
$query = $collectionQuerySecond->addFieldToFilter('main_table.query_text', ['in' => ['test_graph']])->getFirstItem();
$queryResource->delete($query);

$collectionQueryThird = $collectionQueryFactory->create();
$query = $collectionQueryThird->addFieldToFilter('main_table.query_text', ['in' => ['test_graph_']])->getFirstItem();
$queryResource->delete($query);
