# Hyvä UI Plugin - HTML Dialog

[![License]](../../../LICENSE.md)
[![Hyva Supported Versions]](https://docs.hyva.io/hyva-ui-library/getting-started.html)
[![Figma]](https://www.figma.com/@hyva)

Port of the AlpineJS Plugin HTML Dialog, please refer to the [Fylgja AlpineJS Dialog] docs for more information.
...
Original code is licensed, under a [MIT license](https://github.com/fylgja/alpinejs-dialog/blob/main/LICENSE)
to [Fylgja CSS](https://fylgja.dev/).
